...
with st.sidebar:
    st.title('🦜️🔗RJ - PDF BASED LLM-LANGCHAIN CHATBOT🤗')
    st.markdown('''
    ## About APP:
    ...
    - [Linkedin](https://www.linkedin.com/in/rakshith-j-a08811254/)
    
    ''')

    add_vertical_space(4)
    st.write('💡All about pdf based chatbot, created by Rakshith  🤗')
